...
if st.button("Klik disini ya sayang ❤️") or st.session_state.clicked_1:
    ...
    if st.button("Klik Lagi yaa 😘 ") or st.session_state.clicked_2:
        ...
        if st.button("Klik lagi 🥳 ") or st.session_state.clicked_3:
            ...
            st.markdown("<h3 style='text-align: center;'>🎂 Happy 26 sayangku! 🎂</h3>", unsafe_allow_html=True)
...
#     whatsapp_url = f"https://wa.me/62895616059497?text={encoded_wish}"
    
#     # Menampilkan harapan dan balasan otomatis
#     st.write(f"Harapanmu: {user_wish}")
#     st.write("Aku pun berdoa itu akan menjadi kenyataan 🙏")

#     # Menambahkan tombol untuk membuka WhatsApp
#     st.markdown(f"""
#     <a href="{whatsapp_url}" target="_blank">
#         <button style="font-size:20px; padding:10px 20px; background-color: #25D366; color: white; border: none; border-radius: 5px; cursor: pointer;">
